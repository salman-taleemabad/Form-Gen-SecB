#!/usr/bin/env python3
"""
Simple test script to test rubric generation from string and print the full rubric
"""
...
def test_rubric_generation():
    """Test generating rubric from string and print the full result"""
    print("🚀 Testing Rubric Generation from String")
    print("=" * 60)
...
def main():
    """Run the test"""
    success, data = test_rubric_generation()
    ...
    if success:
        ...
        try:
            ...
            print("💾 Full rubric saved to 'rubric_output.json'")
        except Exception as e:
