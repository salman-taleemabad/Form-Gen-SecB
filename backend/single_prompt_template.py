# Single prompt template for matching teammate's approach
SINGLE_PROMPT_TEMPLATE = """You are an expert lesson fidelity rubric generator. Your job is to create a lesson-specific JSON rubric for indicators B1–B11 based ONLY on the provided lesson plan.
